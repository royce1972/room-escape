    ...
    <div>
      <div id={styles.vault} className="vault">
        ...
        <div id={styles.keypad} className="vault">
          <button id={styles.btn1} className="vault" onClick={() => {
          ...
          <button id={styles.btn2} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(2);
            } else {
              return undefined;
          ...
          <button id={styles.btn3} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(3);
            } else {
              return undefined;
          ...
          <button id={styles.btn4} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(4);
            } else {
              return undefined;
          ...
          <button id={styles.btn5} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(5);
            } else {
              return undefined;
          ...
          <button id={styles.btn6} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(6);
            } else {
              return undefined;
          ...
          <button id={styles.btn7} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(7);
            } else {
              return undefined;
          ...
          <button id={styles.btn8} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(8);
            } else {
              return undefined;
          ...
          <button id={styles.btn9} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(9);
            } else {
              return undefined;
          ...
          <button id={styles.btn0} className="vault" onClick={() => {
            if (inputtedPassWd.length < 4) {
              inputPassWd(0);
            } else {
              return undefined;
